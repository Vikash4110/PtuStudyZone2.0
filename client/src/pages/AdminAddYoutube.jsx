...
const AdminAddYoutube = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`${backendUrl}/api/admin/youtube/add`, {
        method: 'POST',
        headers: {
      ...
      toast.error('Failed to add youtube');
    }
  };
  ...
  return (
    ...
    <section className="bg-white shadow-md rounded my-6 p-6">
      <h1 className="text-2xl font-semibold mb-4">Add New Youtube</h1>
...
export default AdminAddYoutube;
