  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setLoading(false); // Stop loading whether the fetch is successful or failed
      }
    };
        ...
        <div className="container mx-auto text-center px-4">
          ...
          {loading ? (
            <div className="flex justify-center items-center min-h-[300px] mb-6">
              <ClipLoader color="#4f46e5" loading={loading} size={50} /> {/* Use ClipLoader */}
            </div>
          ) : (
            <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4 w-5/6 h-full justify-center">
              {filteredSyllabus.length > 0 ? (
                ...
                <div className='relative flex justify-center items-center flex-col text-center sm:text-left mb-10 mt-6 col-start-1 col-span-3'>
                  <h1 className='text-base sm:text-lg xl md:text-xl font-bold flex items-center justify-center sm:justify-start'>
