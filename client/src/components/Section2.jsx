        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2 lg:justify-center">
            <div className="flex flex-col items-center lg:items-start">
              <h1 className="mt-4 text-4xl font-bold text-black lg:mt-8 sm:text-6xl xl:text-7xl text-center lg:text-left">
                WELCOME TO
                <span className="text-[#ed1f26] block">PTU STUDY ZONE</span>
              </h1>
              <p className="mt-4 text-base text-black lg:mt-8 sm:text-xl text-center lg:text-left">
            ...
            <div className="w-2/3 lg:w-full m-auto">
              <img className="w-full " src={Img1} alt="Study Zone" />
            </div>
          </div>
        </div>
      </section>
